...
model = load_model(
    '/home/gelo/codes/ANN_PX4_PATH_PLANING/Redes_salvas/dritk_qualificacao.h5')

init_fonts()
fig = plt.figure(figsize=(15,15),dpi=200)
#ax = fig.add_subplot(1, 2, 1, projection='3d')
ax = plt.axes(projection='3d')
#ax = fig.plot(projection='3d')
ax.set_xlabel('X, [m]')
ax.set_ylabel('Y, [m]')
ax.set_zlabel('Z, [m]')
#ax.set_xlim([-2.5, 2.5])
...
#obstacles_poses =[[15,15,6],[15,15,22.5],[15,4,4],[15,4,22.5],[15,23,4],[15,23,22.5],[15,10,27.5],[15,10,10],[0,15,15],[15,0,15],[15,15,30],[15,15,0],[15,30,15],[30,15,15]]
#obstacles_dims  =[[30,2,12],[30,2,15],[30,2,8],[30,2,15],[30,2,8],[30,2,15],[30,1,5],[30,1,20],[0.5,30,30],[30,0.5,30],[30,30,0.5],[30,30,0.5],[30,0.5,30],[0.5,30,30]]
...
# ;ax.scatter3D(stop[0], stop[1], stop[2], color='red', s=100)
stop = np.array([28, 20, 3])
max = direcao = 0
